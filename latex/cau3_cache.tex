...
\begin{tikzpicture}[scale=0.9]
    ...
    \node at (1.75,0.4) {\texttt{00000000000000}};
    \node at (1.75,-0.3) {Tag (14 bit)};
    
    % Index
    \draw[fill=green!30] (3.5,0) rectangle (7.5,0.8);
    \node at (5.5,0.4) {\texttt{101100000100}};
...
\textbf{Tag:} $00000000000000_2$
\begin{tcolorbox}[colback=formulabox]
\[
\text{Tag} = 0 \times 2^{13} + ... + 0 \times 2^0 = 0_{10}
\]
\end{tcolorbox}

\textbf{Index:} $101100000100_2$
\begin{tcolorbox}[colback=formulabox]
\begin{align*}
\text{Index} &= 1 \times 2^{11} + 0 \times 2^{10} + 1 \times 2^9 + ... + 0 \times 2^1 + 0 \times 2^0 \\
&= 2048 + 512 + 256 + 4 \\
&= 2820_{10}
\end{align*}
\end{tcolorbox}
...
\textbf{Vùng nhớ} = Tag = $\mathbf{0}$ (đánh số từ 0)
...
\textbf{Giải thích:} Với Tag = 0, địa chỉ này thuộc nhóm block đầu tiên được ánh xạ vào cache, tương ứng với vùng nhớ thấp nhất.
\end{tcolorbox}
...
\[
\textbf{Cache Line} = \text{Index} = \boxed{2820}
\]
\end{tcolorbox}
...
\begin{tikzpicture}[scale=0.7]
    ...
    % Zones - drawn individually to avoid foreach parsing issues
    % Vùng 0 - highlighted
    \draw[fill=yellow!50] (0,0) rectangle (3,0.5);
    \node at (1.5,0.25) {\tiny \textbf{Vùng 0}};
    
    \draw (0,1.1) rectangle (3,1.6);
    \node at (1.5,1.35) {\tiny Vùng 1};
    
    \draw (0,2.2) rectangle (3,2.7);
    \node at (1.5,2.45) {\tiny Vùng 2};
    
    \draw (0,4.4) rectangle (3,4.9);
    \node at (1.5,4.65) {\tiny ...};
    
    \draw (0,5) rectangle (3,5.5);
    \node at (1.5,5.25) {\tiny Vùng 16383};
    ...
    % Lines - drawn individually to avoid foreach parsing issues
    \draw (6,0) rectangle (9,0.4);
    \node at (7.5,0.2) {\tiny Line 0};
    
    \draw (6,0.5) rectangle (9,0.9);
    \node at (7.5,0.7) {\tiny Line 1};
    
    \draw (6,1) rectangle (9,1.4);
    \node at (7.5,1.2) {\tiny ...};
    
    % Line 2820 - highlighted
    \draw[fill=green!50] (6,2.8) rectangle (9,3.2);
    \node at (7.5,3.0) {\tiny \textbf{Line 2820}};
    
    \draw (6,5) rectangle (9,5.4);
    \node at (7.5,5.2) {\tiny Line 4095};
...
\begin{itemize}
    \item \textbf{Vùng nhớ (Tag):} 0
    \item \textbf{Cache Line:} 2820
