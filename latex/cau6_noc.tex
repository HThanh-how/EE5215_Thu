...
\begin{itemize}
    ...
    \item 'k' và 'l' sẽ hoàn thành trong các chu kỳ T=9 và T=10.
...
\hline
Gói 2 (C$\rightarrow$D) & C-W-D & T = 5 & 5T \\
\hline
Gói 3 (E$\rightarrow$H) & E-Y-X-H & T = 9 & 9T \\
\hline
\end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \item Gói 2: 5T (lý tưởng)
    \item Gói 3: 9T (thêm 3T do blocking tại Y)
\end{itemize}
