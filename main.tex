...
\textbf{SCL} & H L 18{C} 18{C} H \\
\textbf{SDA} & H L 2D{1} 2D{0} 2D{0} 2D{1} 2D{1} 2D{0} 2D{0} 2D{{\tiny R/W}} 2L
                 2D{0} 2D{0} 2D{0} 2D{1} 2D{0} 2D{0} 2D{1} 2D{0} 2L H \\
\extracode
\begin{pgfonlayer}{background}
\vertlines[help lines]{1.0,3.0,...,37.0}
\end{pgfonlayer}
\tablerules
\end{tikztimingtable}
\end{center}
\begin{center}
    \small \textit{Sơ đồ thời gian: Start $\to$ Addr(0x4C) + W $\to$ ACK $\to$ Data(0x12) $\to$ ACK $\to$ Stop}
\end{center}
