...
\hline
$00\,0000\,0000\,0000$ & $1011\,0000\,0100$ & $10\,1101$ \\
\hline
$0000\,0000\,0000\,00_2 = 0_{10}$ & $1011\,0000\,0100_2 = 2820_{10}$ & $101101_2 = 45_{10}$ \\
\hline
\end{tabular}
\end{center}
...
\textbf{Vùng nhớ chính:} Tag = 0 $\Rightarrow$ Thuộc \textbf{vùng 0}.

\textbf{Bước 4: Xác định line trong cache (với Direct Mapping):}
\[
\text{Cache line} = \text{Index} = \boxed{2820}
\]
...
\textbf{SCL} & H L 27{C} L H \\
\textbf{SDA} & H L 2D{1} 2D{0} 2D{0} 2D{1} 2D{1} 2D{0} 2D{0} 2D{0} 2L
                 2D{0} 2D{0} 2D{0} 2D{1} 2D{0} 2D{0} 2D{1} 2D{0} 2L
                 2D{0} 2D{0} 2D{1} 2D{1} 2D{0} 2D{1} 2D{0} 2D{0} 2L L H \\
\extracode
\begin{pgfonlayer}{background}
\vertlines[help lines]{1.0,3.0,...,57.0}
\end{pgfonlayer}
\tablerules
\end{tikztimingtable}
\end{center}
\begin{center}
    \small \textit{Sơ đồ thời gian: Start $\to$ Addr(0x4C) + W $\to$ ACK $\to$ Data(0x12) $\to$ ACK $\to$ Data(0x34) $\to$ ACK $\to$ Stop}
\end{center}
...
\begin{itemize}
    ...
    \item 'h' $\rightarrow$ D (Gói 2 hoàn thành!)
